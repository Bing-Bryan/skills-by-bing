...
Related non-Skill runtime project: [Codex External Subagent Runtime](https://github.com/Bing-Bryan/codex-external-subagent-runtime), a Codex Desktop bootstrap, launcher, and runtime route contract.
